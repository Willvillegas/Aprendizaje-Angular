...
import { HeroeService as HeroesService } from '../../services/heroe.service';
  ...
  onSubmit() {
    ...
    if (this.currentHero.id) {
      ...
      this.heroesService.createHero(this.currentHero)
        .subscribe(hero => {
          this.router.navigate(['/heroes/edit', hero?.id]);
          this.snackbar.open(`Héroe ${hero?.superhero} creado!`, 'Cerrar',{duration: 3000});
        });
    }
  }
        ...
        this.heroesService.deleteHero(this.currentHero.id!)
          .subscribe(wasDeleted => {
            if (wasDeleted) {
              ...
              this.snackbar.open(`Héroe ${this.currentHero.superhero} eliminado!`, 'Cerrar', { duration: 3000 });
            }
